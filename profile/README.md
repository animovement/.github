...
## Packages
The *animovement* package consists of seven core packages, each focused on a specific stage of the workflow:

| Package   | Status | Core purpose      | Short description                                                                                     |
|-----------|-----|-------------------|--------------------------------------------------------------------------------------------------------|
| [anicore](https://github.com/animovement/anicore)  | [![R-CMD-check](https://github.com/animovement/anicore/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/animovement/anicore/actions/workflows/R-CMD-check.yaml) | Data structures | Provides core data structures for movement data.                               |
| [aniread](https://github.com/animovement/aniread) | [![R-CMD-check](https://github.com/animovement/aniread/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/animovement/aniread/actions/workflows/R-CMD-check.yaml)  | Import / Export   | Reads/writes data from video trackers, trackballs, and other sources.                                 |
...
| [anispace](https://github.com/animovement/anispace) | [![R-CMD-check](https://github.com/animovement/anispace/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/animovement/anispace/actions/workflows/R-CMD-check.yaml) | Spatial transformations | Converts coordinate systems and reference frames. |
