...
| [aniread](https://github.com/animovement/aniread) | [![R-CMD-check](https://github.com/animovement/aniread/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/animovement/anicore/actions/workflows/R-CMD-check.yaml)  | Import / Export   | Reads/writes data from video trackers, trackballs, and other sources.                                 |
